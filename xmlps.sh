...
ln -s /var/www/html/vendor/dyve/jquery-autocomplete/src/jquery.autocomplete.js style/css/jquery.autocomplete.css
ln -s /var/www/html/vendor/dyve/jquery-autocomplete/src/jquery.autocomplete.js javascript/jquery.autocomplete.css
